...
export const ServiceCard = (services) => {
  return (
    ...
    {services?.services.map(service =>
        <div key={service.id} className=" cursor-pointer flex flex-col mx-4 hover:border-4 rounded-lg  hover:border-green-400 transition ease-in-out delay-100 duration-300 hover:-translate-y-4 items-center hover:scale-100 hover:drop-shadow-sm">
