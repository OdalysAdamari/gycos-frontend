...
export const Homepage = () => {
  ...
  return (
    <div className="font-inter bg-gray-100">
      ...
      <section className="relative flex items-center justify-center min-h-screen bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('/portal/uploads/dashboard_cover_058675caff.png')" }}>
