...
export const Contact = () => {
  return (
    <div className=''>
      <div className="flex flex-col justify-center items-center m-0  sm:m-4 rounded-xl bg-[#f0f0f0] w-screen" >
        <div className="h-[50vh] md:h-[60vh] flex flex-col justify-evenly my-10 p-10 rounded-2xl items-center  bg-[#ebebeb] w-screen  py-10 ">
              <h1 className="text-3xl md:text-6xl mt-2 md:mt-4 ">CONTACTANOS</h1>
              <span>¿Necesitas un experto? Suspendisse non libero id tellus imperdiet eleifend quis et ligula.  </span>
        </div>

        <section className="py-6 dark:bg-gray-800 dark:text-gray-50 ">
          <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
            <div className="py-6 md:py-0 md:px-6 w-full">
      ...
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col justify-center p-4 px-10 sm:px-4 sm:mx-auto md:p-8 sm:max-w-[40%]">
          <h2 className="mb-12 text-4xl font-bold leadi text-center sm:text-5xl">Preguntas frecuentes</h2>
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
            <details className="w-full max-w-[screen]">
